set term !! ;
create trigger TDPOMOD for CRDEPOT
before update
position 0 as
/*
;/T/ Modification dans la table CRDEPOT
;
...
begin
  ...
  then begin
    if (     OLD.DPOMNTPAM != ( OLD.DPOCUMMNT + OLD.DPOMNTFAC )
         and NEW.DPOMNTPAM  = ( NEW.DPOCUMMNT + NEW.DPOMNTFAC ) )
  ...
  Update CRLOT Set LCRCUMMNT    = LCRCUMMNT - OLD.DPOMNTPAM + NEW.DPOMNTPAM,
