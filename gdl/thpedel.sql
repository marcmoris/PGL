set term !! ;
create trigger THPEDEL for MCHIS_PROJET_ENG
before delete
position 0 as
/* Destruction dans la relation MCHIS_PROJET_ENG
 ;
...
*/
  if ( :t_coddc = "C" )
  then t_eng = (OLD.HPEMNTCRT - OLD.HPEMNTDBT);
  else t_eng = (OLD.HPEMNTDBT - OLD.HPEMNTCRT);
