set term !! ;
create trigger THEESTO for MCHIS_ECR_ENG
before insert
position 0 as
...
*/
  if ( :t_coddc = "C" )
  then t_eng = (NEW.HEEMNTCRT - NEW.HEEMNTDBT);
  else t_eng = (NEW.HEEMNTDBT - NEW.HEEMNTCRT);
...
*/
  ...
  then begin
    Insert Into MCSAN_REST
        ...
        Select  :t_pecann, NEW.CIECLE, NEW.CPTCLE, NEW.UNACLE, NEW.HEECIEINT,
                                                               NEW.HEEUNAINT,
                0,
                0, 0, 0, 0,
                0, 0, 0, 0,
